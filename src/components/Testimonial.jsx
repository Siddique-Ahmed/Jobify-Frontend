...
import img_2 from "../../public/images/carousel_img_2.webp";
import img_3 from "../../public/images/carousel_img_3.webp";
import img_4 from "../../public/images/carousel_img_4.webp";
import img_5 from "../../public/images/carousel_img_5.webp";
...
const Testimonial = () => {
  return (
    <div className="w-full py-10 px-3 sm:px-4 flex flex-col items-center gap-5">
      <h1 className="font-semibold text-4xl text-[var(--dark-bg)]">Testimonials</h1>
